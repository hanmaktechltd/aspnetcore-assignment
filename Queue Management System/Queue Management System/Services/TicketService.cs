...
public class TicketService : ITicketService { 
    ...
    public Ticket SaveTicketToDatabase(string serviceType)
{
    ...
    using (var connection = new NpgsqlConnection(_connectionString))
    {
        ...
        using (var command = new NpgsqlCommand())
        {
            ...
            command.CommandText = @"
                INSERT INTO Ticket (ServiceType, IssueTime)
                VALUES (@ServiceType, CURRENT_TIMESTAMP)
                RETURNING TicketId, ServiceType, IssueTime;
            ";
            ...
            using (var reader = command.ExecuteReader())
            {
                if (reader.Read())
                {
                    ...
                    ticket.IssueTime = reader.GetDateTime(2);
                }
            }
        }
    }
