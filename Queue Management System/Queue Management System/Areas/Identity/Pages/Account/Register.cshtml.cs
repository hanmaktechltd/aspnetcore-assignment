...
namespace Queue_Management_System.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!await _roleManager.RoleExistsAsync(StrValues.AdminTole))
            {
                await _roleManager.CreateAsync(new IdentityRole(StrValues.AdminTole));
                await _roleManager.CreateAsync(new IdentityRole(StrValues.ProviderRole));
                await _roleManager.CreateAsync(new IdentityRole(StrValues.UserRole));
            }
